...
namespace NamPhuThuy.Common
{
    ...
    public static class YieldHelper
    {
        ...
        // -------- Settings --------
        // Max unique durations we’ll keep alive for each cache.
        // Tune to your game; 64-256 is usually plenty.
        private const int DEFAULT_CAPACITY = 128;

        // Round seconds to this many decimal places before caching (e.g., 3 => millisecond).
        // Prevents tiny float differences from creating tons of distinct keys.
        private const int SECONDS_PRECISION = 3;
     ...
     */
        ...
        static Dictionary<float, WaitForSecondsRealtime> _timeIntervalRealtime =
